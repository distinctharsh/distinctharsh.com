...
export default function Footer() {
  return (
    <footer className="flex w-full flex-col items-center gap-20 bg-transparent px-6 py-8 sm:px-14 md:px-20">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-6 rounded-2xl bg-accent p-8 text-background sm:p-10 md:gap-8 lg:p-12">
        <div className="text-center">
          <h2 className="text-2xl font-bold md:text-3xl lg:text-4xl">
            Let&apos;s build something great.
          </h2>
          <p className="mt-2 text-base text-background/80 md:text-lg">
      ...
      <div className="flex w-full flex-col items-center justify-between gap-8 text-center  md:flex-row md:justify-between lg:mx-auto lg:max-w-7xl">
        <span className="text-foreground">©2026 Harsh Singh</span>
